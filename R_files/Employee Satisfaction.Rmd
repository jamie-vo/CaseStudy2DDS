...
qqPlot(linearMod, main="QQ Plot") #qq plot for studentized resid

# 4. Outliers 
outlierTest(linearMod) # Bonferonni p-value for most extreme obs

leveragePlots(linearMod) # leverage plots
